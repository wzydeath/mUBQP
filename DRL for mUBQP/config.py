...
def arg_parser():
    ...
    parser.add_argument('-alpha', '--alpha', metavar='ALPHA', type=float, default='0.4', help='heap alpha')
    parser.add_argument('-beta', '--beta', metavar='BETA', type=float, default='0.6', help='heap beta')

    parser.add_argument('-nb', '--nbuffer', metavar='NBUFFER', type=int, default='100000', help='buffer size')
    parser.add_argument('-gamma', '--gamma', metavar='GAMMA', type=float, default='0.99', help='reward decay')
...
class Config():
    def __init__(self, **kwargs):
        for k, v in kwargs.items():
            self.__dict__[k] = v
        self.task = 'TSP%d_%s' % (self.n_customer, self.mode)
...
def test_parser():
    ...
    parser.add_argument('-n', '--n_customer', metavar='N', type=int, default=10,
                        help='number of customer nodes, time sequence')
    ...
    parser.add_argument('-d', '--decode_type', metavar='D', type=str, required=True, choices=['greedy', 'sampling'],
